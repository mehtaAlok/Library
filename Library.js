...
let book1 = new Book("Harry Potter", "JK Rowling", "250", "read");
let book2 = new Book("Free will", "Sam Harris", "120", "not read");
...
let displayBooks = () => {
    ...
    for(i=0; i<myLibrary.length; i++) {
        ...
        removeButton.onclick = function() {removeBooksFunc(removeButton.id);};
        // readBookCheck.onclick = function() {Book.toggleRead(readBookCheck.id)}
        readBookCheck.onclick = function() {toggleRead(readBookCheck.id)};
